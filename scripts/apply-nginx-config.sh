...
MANUS_VIRAL_MAKER_HOST="${MANUS_VIRAL_MAKER_HOST:-viralmaker-wizzwuwp.manus.space}"
...
if [[ -L /etc/nginx/sites-enabled/viral-maker.ru ]] || [[ -f /etc/nginx/sites-available/viral-maker.ru ]]; then
